...
const Navigation = memo(() => {
  ...
  const navClass = (path: string) => 
    `flex items-center gap-2 px-4 py-2 rounded-2xl transition-all duration-500 font-bold ${
...
const Footer = memo(() => (
  <footer className="pt-20 pb-40 sm:pb-20 relative overflow-hidden">
    <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
      ...
      <p className="font-bold text-white/80 text-sm mb-8">Natick High School Chinese Club & NCA</p>

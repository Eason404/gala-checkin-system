  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-right-4 duration-500">
      <div className="text-center">
        <h3 className="text-4xl font-black text-gray-900 tracking-tight">新年献礼 · 选择票种<br /><span className="text-2xl mt-2 block opacity-80">Select Your Ticket</span></h3>
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        >
          ...
          <div className="absolute top-0 right-0 bg-gradient-to-r from-orange-500 to-cny-red text-white px-8 py-3 rounded-bl-[2rem] font-black text-xs uppercase tracking-widest shadow-xl flex items-center gap-2 animate-pulse">
            <Flame className="w-4 h-4 fill-white" /> 限量 25% OFF · 最值推荐 BEST VALUE
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="flex items-center gap-2 bg-white/80 p-3.5 rounded-2xl border border-gray-100 shadow-sm group-hover:bg-cny-red group-hover:text-white transition-colors">
              ...
              <span className="text-[9px] font-black text-gray-800 uppercase tracking-tighter group-hover:text-white transition-colors">“贺岁锦绣”开运午餐<br />Festive Lunch</span>
            </div>
            <div className="flex items-center gap-2 bg-white/80 p-3.5 rounded-2xl border border-gray-100 shadow-sm group-hover:bg-cny-red group-hover:text-white transition-colors">
              ...
              <span className="text-[9px] font-black text-gray-800 uppercase tracking-tighter group-hover:text-white transition-colors">春晚尊享坐席<br />Gala Seats</span>
            </div>
            <div className="flex items-center gap-2 bg-white/80 p-3.5 rounded-2xl border border-gray-100 shadow-sm group-hover:bg-cny-red group-hover:text-white transition-colors">
              ...
              <span className="text-[9px] font-black text-gray-800 uppercase tracking-tighter group-hover:text-white transition-colors">马年锦鲤抽奖<br />Raffle Entry</span>
            </div>
            <div className="flex items-center gap-2 bg-white/80 p-3.5 rounded-2xl border border-gray-100 shadow-sm group-hover:bg-cny-red group-hover:text-white transition-colors">
              ...
              <span className="text-[9px] font-black text-gray-800 uppercase tracking-tighter group-hover:text-white transition-colors">新春庙会通行<br />Temple Fair</span>
            </div>
          </div>
      ...
      <div className="pt-4">
        ...
        <p className="text-center text-[10px] text-gray-400 font-bold uppercase tracking-[0.3em] mt-6">
          现场签到时支付 · 仅限现金或支票<br />Pay on site (Cash/Check only)
        </p>
      </div>
    </div>
  );

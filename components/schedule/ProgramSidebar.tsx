  ...
  return (
    <div className="space-y-10">
      ...
      <div className="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-cny-gold/5">
        <div className="bg-cny-red/5 p-6 border-b border-gray-100">
          ...
          {performances.map((perf, idx) => (
            <div key={idx} className="p-6 hover:bg-cny-cloud/10 transition-colors group">
              <div className="flex justify-between items-start mb-2">
                <h5 className="font-bold text-gray-800 leading-snug text-[15px] group-hover:text-cny-red transition-colors tracking-tight">{perf.title}</h5>
